...
public class UserRepositoryImpl implements UserRepository {
	...
	private final UserFileRepository userDbRepository;
	
	private final UserFileMapper userDbMapper;

	@Autowired
	public UserRepositoryImpl(UserFileRepository userDbRepository, UserFileMapper userDbMapper) {
